...
| 5 | `lab-audit-05-connection-observability.md` | GAP-BE-004, §9.2 矩阵 | P2 | todo |

### 二、面板架构治理

| # | Plan 文件 | 审计 ID | 优先级 | 状态 |
|---|-----------|---------|--------|------|
| 6 | `lab-audit-06-panel-arch-convergence.md` | PANEL-ARCH-001~005, §55 | P0 | todo |
| 7 | `lab-audit-07-entry-cleanup.md` | PANEL-ARCH-003, §54.4 Remove 清单 | P1 | todo |

### 三、面板功能落地

| # | Plan 文件 | 审计 ID | 优先级 | 状态 |
|---|-----------|---------|--------|------|
| 8 | `lab-audit-08-terminal-v1.md` | PANEL-TERM-001, §5, §10, §15 | P0 | todo |
| 9 | `lab-audit-09-ai-panel.md` | PANEL-AI-001, §22 | P0 | todo |
| 10 | `lab-audit-10-errors-batch-bc.md` | ERR-205~208, §29 | P1 | in-progress |
| 11 | `lab-audit-11-run-console.md` | PANEL-LOG-001, PANEL-RUNCONSOLE-001, PANEL-LEFT-001, §26~27 | P0 | todo |
...
| 14 | `lab-audit-14-files-consolidation.md` | PANEL-FILES-001, §45 | P0 | todo |
| 15 | `lab-audit-15-notebook-map.md` | PANEL-OUT-001, PANEL-GRAPH-001, §42~43 | P1 | todo |
| 16 | `lab-audit-16-secrets.md` | PANEL-SEC-001, PANEL-SEC-002, §38~39 | P1 | todo |
...
| 19 | `lab-audit-19-export-script.md` | GAP-BE-003 | P1 | todo |
