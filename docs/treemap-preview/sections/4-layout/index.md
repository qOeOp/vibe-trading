...
Full page structure: HeatMap Container → Header + Treemap Body arrangement.
...
### [Header Scroll Effects](./threads/header-scroll-effects/index.md)
...
HeatMap Container (920px-100vw × auto height, 8px padding)
  ├── HeatMapHeader (固定顶部, 60-80px)
  │     ├── Title + Search + Toggles (第一行)
  │     └── Breadcrumb (第二行)
  │
...
**Key Measurement:** 580px max height applies to **Treemap Body only**, excluding Header.
