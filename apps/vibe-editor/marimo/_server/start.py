...
def start(
    *,
    ...
    from vt_sessions import VTSessionManager
    vt_manager = VTSessionManager()
    app.state.vt_session_manager = vt_manager

    # Start idle session cleanup after event loop is running
