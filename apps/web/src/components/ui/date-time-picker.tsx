...
import type { TEventFormData } from '@/features/journal/calendar/schemas';
...
function DateTimePicker({ form, field }: DatePickerProps) {
  ...
  return (
    <FormItem data-slot="date-time-picker" className="flex flex-col">
      <FormLabel>
        ...
        <PopoverContent className="w-auto p-0">
          <div className="sm:flex">
            <Calendar
              ...
              initialFocus
            />
            <div className="flex flex-col sm:flex-row sm:h-[300px] divide-y sm:divide-y-0 sm:divide-x divide-mine-border">
