      ...
      >
        {withoutSlot ? (
          ...
          <Slot
            ...
            {...(contentProps as React.ComponentProps<typeof Slot>)}
            // React 19 Ref type is incompatible with Radix Slot's React 18 ref type
            ref={ref as never}
          >
            {children}
          </Slot>
...
function SortableItem(props: SortableItemProps) {
  ...
  return (
    <SortableItemContext.Provider value={itemContext}>
      {asChild ? (
        <Slot
          {...(itemProps as React.ComponentProps<typeof Slot>)}
          {...(sharedProps as React.ComponentProps<typeof Slot>)}
          // React 19 Ref type is incompatible with Radix Slot's React 18 ref type
          ref={composedRef as never}
        />
      ) : (
        <div {...itemProps} {...sharedProps} ref={composedRef} />
      )}
...
function SortableItemHandle(props: SortableItemHandleProps) {
  ...
  const sharedHandleProps = {
    ...
    'data-dragging': itemContext.isDragging ? ('' as const) : undefined,
    'data-slot': 'sortable-item-handle' as const,
  ...
  return asChild ? (
    <Slot
      {...(itemHandleProps as React.ComponentProps<typeof Slot>)}
      {...(sharedHandleProps as React.ComponentProps<typeof Slot>)}
      // React 19 Ref type is incompatible with Radix Slot's React 18 ref type
      ref={composedRef as never}
    />
  ) : (
    <button {...itemHandleProps} {...sharedHandleProps} ref={composedRef} />
  );
}
