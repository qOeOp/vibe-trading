...
| Chart                    | chart.tsx                       | Chart           | active | Recharts wrapper   |
...
| PanelSearchBar    | panel-search-bar.tsx    | Input/Search    | active | 搜索栏                    |
...
- **Pencil 覆盖: 77/77 (100%)**
- Pencil 可复用组件总数: 85
- Pencil L3/feature 组件 (不计入 L1/L2): StatusDot/Active, StatusDot/Warning, StatusDot/Error, FactorDetailPanel
