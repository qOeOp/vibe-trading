...
/**
 * @fileoverview Horizontal normalized bar chart component
 *
 * @migrated-from ngx-charts
 * @source https://github.com/swimlane/ngx-charts
 * @commit e241d94221430000a8fddaa9eb4d8f2878ed8a38
 * @original-file projects/swimlane/ngx-charts/src/lib/bar-chart/bar-horizontal-normalized.component.ts
 *
 * @description
 * Horizontal normalized bar chart where stacked series are shown as
...
interface BarHorizontalNormalizedInnerProps extends Omit<MultiSeriesBarChartProps, 'width' | 'height' | 'className'> {
 ...
 */
const BarHorizontalNormalizedInner = memo(function BarHorizontalNormalizedInner({
  data,
  containerWidth,
  containerHeight,
  colorScheme = 'vivid',
  ...
  onActivate,
  onDeactivate,
}: BarHorizontalNormalizedInnerProps) {
...
/**
 * Horizontal normalized bar chart component
 */
export function BarHorizontalNormalized({
  width,
  height,
  className,
  ...props
