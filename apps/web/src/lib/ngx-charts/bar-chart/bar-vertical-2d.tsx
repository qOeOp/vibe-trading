...
/**
 * @fileoverview Vertical grouped bar chart component
 *
 * @migrated-from ngx-charts
 * @source https://github.com/swimlane/ngx-charts
 * @commit e241d94221430000a8fddaa9eb4d8f2878ed8a38
 * @original-file projects/swimlane/ngx-charts/src/lib/bar-chart/bar-vertical-2d.component.ts
 *
 * @description
 * Vertical grouped bar chart (2D) where multiple series are displayed
...
interface BarVerticalGroupedInnerProps extends Omit<MultiSeriesBarChartProps, 'width' | 'height' | 'className'> {
 ...
 */
const BarVerticalGroupedInner = memo(function BarVerticalGroupedInner({
  data,
  containerWidth,
  containerHeight,
  colorScheme = 'vivid',
    ...
    <>
      <svg width={containerWidth} height={containerHeight} className="ngx-charts" style={{ overflow: 'visible', fontFamily: 'var(--font-chart, Roboto, sans-serif)' }}>
        <g transform={transform} className="bar-chart chart">
          <GridPanelSeries
            xScale={groupScale}
            yScale={groupScale as unknown as ScaleBand<string>}
...
/**
 * Vertical grouped bar chart component
 */
export function BarVerticalGrouped({
  width,
  height,
  className,
  ...props
...
export { BarVerticalGrouped as BarVertical2D };
