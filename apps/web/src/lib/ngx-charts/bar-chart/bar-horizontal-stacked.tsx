...
/**
 * @fileoverview Horizontal stacked bar chart component
 *
 * @migrated-from ngx-charts
 * @source https://github.com/swimlane/ngx-charts
 * @commit e241d94221430000a8fddaa9eb4d8f2878ed8a38
 * @original-file projects/swimlane/ngx-charts/src/lib/bar-chart/bar-horizontal-stacked.component.ts
 *
 * @description
 * Horizontal stacked bar chart where multiple series are stacked
 ...
 */
const BarHorizontalStackedInner = memo(function BarHorizontalStackedInner({
  data,
  containerWidth,
  containerHeight,
  colorScheme = 'vivid',
  ...
  onActivate,
  onDeactivate,
}: BarHorizontalStackedInnerProps) {
  ...
  const handleDataLabelWidthChanged = useCallback((event: { size: { width: number; negative: boolean }; index: number }, _groupIndex: number) => {
