...
import { DataTableSliderFilter } from '@/lib/data-table/components/data-table-slider-filter';
        ...
        case 'number':
          return (
            <div className="relative">
              ...
              />
              {columnMeta.unit && (
                <span className="absolute top-0 right-0 bottom-0 flex items-center rounded-r-md bg-mine-hover px-2 text-mine-muted text-sm">
                  {columnMeta.unit}
                </span>
              )}
            </div>
