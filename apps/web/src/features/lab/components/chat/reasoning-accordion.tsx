  ...
  return (
    ...
    >
      <AccordionItem value="reasoning" className="border-0">
        <AccordionTrigger className="text-xs text-mine-muted hover:bg-mine-hover/50 px-2 py-1 h-auto rounded-sm [&[data-state=open]>svg]:rotate-180">
        ...
        <AccordionContent className="pb-2 px-2">
          <div className="bg-mine-hover/30 border border-muted/50 rounded-md p-3 italic text-mine-muted/90 relative">
            <div className="pr-6">
