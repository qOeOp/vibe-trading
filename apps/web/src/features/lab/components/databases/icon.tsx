...
// Next.js imports PNG as StaticImageData, SVG as string
const URLS: Record<DBLogoName, string | { src: string } | undefined> = {
  sqlite: SQLiteIcon,
  duckdb: DuckDBIcon,
...
export const DatabaseLogo: FC<DatabaseLogoProps> = ({ name, className }) => {
  ...
  const raw = URLS[lowerName as DBLogoName];
  ...
  // Next.js imports PNG as StaticImageData ({ src, width, height })
