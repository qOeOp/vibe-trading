...
export const button = cva(
  'flex items-center justify-center m-0 leading-none font-medium border border-mine-border shadow-xs-solid active:shadow-none text-sm',
  {
    variants: {
      color: {
...
export const input = cva(
  'font-mono w-full flex-1 inline-flex items-center justify-center rounded px-2.5 text-mine-text/60 h-[36px] hover:shadow-md hover:cursor-pointer focus:shadow-md focus:outline-hidden text-[hsl(0, 0%, 43.5%)] bg-transparent hover:bg-mine-page-bg focus:bg-mine-page-bg',
);
