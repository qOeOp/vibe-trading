...
function StepArrow() {
  return (
    <svg
      ...
      className="shrink-0"
    >
      <path d="M0 9H48" stroke="var(--color-mine-border)" />
  ...
  return (
    ...
    >
      <path
        ...
        fill="var(--color-mine-accent-red)"
      />
    </svg>
  );
}
...
function StepDone() {
  return (
    <svg
      ...
      className="shrink-0"
    >
      <circle cx="8" cy="8" r="7.5" fill="var(--color-mine-accent-green)" />
      <path
            ...
            <div
              className={cn(
                ...
                isActive || isDone
                  ...
                  : 'bg-mine-panel-bg text-mine-muted/60',
              )}
              style={
                isActive || isDone
                  ? {
                ...
                style={{
                  boxShadow:
                    isActive || isDone
                      ...
                      : 'inset 0px 0px 0px 1px var(--color-mine-border)',
                }}
              />
...
function ChromeHeader({
  ...
  return (
    <div
      ...
      className={cn('flex items-center px-4 py-2 bg-mine-hover', className)}
      {...props}
    >
