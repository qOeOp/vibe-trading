      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={`text-[8px] font-semibold px-1.5 py-0.5 rounded ${retentionBgClass(rankPct)}`}
            >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={`text-[8px] font-semibold px-1.5 py-0.5 rounded ${retentionBgClass(binaryPct)}`}
            >
        ...
        <div className="text-[9px] text-mine-muted leading-relaxed mt-1">
          变换后 Sharpe 保留 &gt;70% 表示因子捕捉的是结构性信号；&lt;30%
          提示过拟合风险
        </div>
      </div>
    </PanelSection>
