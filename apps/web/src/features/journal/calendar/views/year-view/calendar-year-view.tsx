      ...
      >
        {MONTHS.map((month, monthIndex) => {
          ...
          return (
            <motion.div
              key={month}
              className="flex flex-col border border-mine-border rounded-lg shadow-sm overflow-hidden"
            ...
            >
              ...
              <div className="grid grid-cols-7 text-center text-xs font-medium text-mine-muted py-2">
                {WEEKDAYS.map((day) => (
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        !isCurrentMonth && "text-mine-muted/40",
                        hasEvents && isCurrentMonth
                          ? "cursor-pointer hover:bg-mine-bg/20 hover:rounded-md"
                          : "cursor-default",
                      )}
                    >
