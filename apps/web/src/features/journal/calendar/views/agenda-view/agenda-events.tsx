          ...
          >
            {groupedEvents!.map((event) => (
              <CommandItem
                key={event.id}
                className={cn(
                  "mb-2 p-4 border rounded-md data-[selected=true]:bg-mine-bg transition-all data-[selected=true]:text-none hover:cursor-pointer",
                  {
                      ...
                      <div className="flex flex-col">
                        <p
                          className={cn({
                            ...
                            "text-mine-text": badgeVariant === "dot",
                          })}
                        >
                          {event.title}
                        </p>
                        <p className="text-mine-muted text-sm line-clamp-1 text-ellipsis md:text-clip w-1/3">
                          {event.description}
                        </p>
                      </div>
                    </div>
