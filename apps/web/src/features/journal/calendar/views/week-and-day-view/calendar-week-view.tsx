          ...
          >
            ...
            <div className="grid flex-1 grid-cols-7 border-l">
              {weekDays.map((day, index) => (
                <motion.span
                  key={day.toISOString()}
                  className="py-1 sm:py-2 text-center text-xs font-medium text-mine-muted"
                ...
                >
                  ...
                  <span className="block sm:hidden">
                    ...
                    <span className="block font-semibold text-mine-text text-xs">
                      {format(day, "d")}
                    </span>
                  </span>
                  ...
                  <span className="hidden sm:inline">
                    {format(day, "EE")}{" "}
                    <span className="ml-1 font-semibold text-mine-text">
                      {format(day, "d")}
                    </span>
                  </span>
                </motion.span>
                      ...
                      {hours.map((hour, index) => (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                className="absolute inset-0 cursor-pointer transition-colors hover:bg-mine-bg" />
                            </AddEditEventDialog>
                          </DroppableArea>

                          <div
                            className="pointer-events-none absolute inset-x-0 top-1/2 border-b border-dashed border-mine-border"></div>
