      ...
      <div className="flex flex-1 flex-col">
        <div>
          ...
          <div className="relative z-20 flex border-b">
            ...
            <span className="flex-1 border-l py-2 text-center text-xs font-medium text-mine-muted">
                ...
                {hours.map((hour, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 cursor-pointer transition-colors hover:bg-mine-bg" />
                      </AddEditEventDialog>
                    </DroppableArea>

                    <div className="pointer-events-none absolute inset-x-0 top-1/2 border-b border-dashed border-mine-border"></div>
        ...
        <div className="flex-1 space-y-3">
          {currentEvents.length > 0 ? (
            <div className="flex items-start gap-2 px-4 pt-4">
              ...
              <p className="text-sm font-semibold text-mine-text">
                Happening now
              </p>
            </div>
          ) : (
            <p className="p-4 text-center text-sm italic text-mine-muted">
                    ...
                    <div key={event.id} className="space-y-1.5">
                      ...
                      {user && (
                        <div className="flex items-center gap-1.5">
                          <User className="size-4 text-mine-muted" />
                          <span className="text-sm text-mine-muted">
                            {user.name}
                          </span>
                        </div>
                      )}
                      ...
                      <div className="flex items-center gap-1.5">
                        <Calendar className="size-4 text-mine-muted" />
                        <span className="text-sm text-mine-muted">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Clock className="size-4 text-mine-muted" />
                        <span className="text-sm text-mine-muted">
                          {format(
