...
function AuthPageContent() {
  return (
    <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
      <div className="relative hidden h-full flex-col border-r bg-mine-hover p-10 lg:flex">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-mine-page-bg" />
        <Logo className="mr-auto h-5" />

        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-xl">&ldquo;Work Smarter, Trade Faster.&rdquo;</p>
      ...
      <div className="relative flex min-h-screen flex-col justify-center p-4">
        ...
        <div className="mx-auto space-y-4 sm:w-sm">
          ...
          <div className="flex w-full items-center justify-center">
            <div className="h-px w-full bg-mine-border" />
            <span className="px-2 text-mine-muted text-xs">OR</span>
            <div className="h-px w-full bg-mine-border" />
          </div>

          <form className="space-y-2">
            <p className="text-start text-mine-muted text-xs">
          ...
          <p className="mt-8 text-mine-muted text-sm">
